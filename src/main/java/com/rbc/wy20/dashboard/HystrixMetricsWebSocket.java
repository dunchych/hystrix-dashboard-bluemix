...
package com.rbc.wy20.dashboard;

import com.rbc.wy20.vcap.IVCapServiceCredentials;
import com.rbc.wy20.vcap.impl.VCapServices;
import com.rbc.wy20.vcap.impl.VCapServiceCredentials;
...
public class HystrixMetricsWebSocket {
    ...
    private  static boolean initRMQ() {
        ...
        IVCapServiceCredentials cred = VCapServiceCredentials.getCredentialsOfFirstService(vservices, "compose-rabbitmq-dedicated");
        if (cred == null) {
