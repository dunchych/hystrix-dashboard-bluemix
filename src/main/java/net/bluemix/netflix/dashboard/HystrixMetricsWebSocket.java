...
package net.bluemix.netflix.dashboard;

import net.bluemix.netflix.vcap.*;
import net.bluemix.netflix.vcap.impl.VCapServices;
...
public class HystrixMetricsWebSocket {
	...
	public void onOpen(Session session, EndpointConfig ec) {
        ...
        addSession(session);
         //spin off a thread for observing hystrix metrics from RMQ
        if (metricsLoop == null) {
         ...
         public void run() {
            ...
            while (isConnected) {
               ...
               /*
                        ...
                        this implementation does not do such aggregation, and simply relays metric messages to the dashboard UI in brower via web socket, so we simply extract metrics data like this
